...
An exemplar plot, displaying Airbnb listings in Harlem where colour is mapped to 'reviews per month' and size is mapped to 'price' is shown and accessible [Here](https://jmrze.github.io/Data-Analysis/exemplar_plot.html)
