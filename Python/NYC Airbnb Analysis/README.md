...
An exemplar plot, displaying Airbnb listings in Harlem where price is mapped to 'reviews per month' and size is mapped to 'price' is shown and accessible [here](https://jmrze-github.io/blob/main/Python/NYC%20Airbnb%20Analysis/docs/exemplar_plot.html)
